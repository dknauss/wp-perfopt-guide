...
- [`enterprise-performance-operational-checklist.md`](enterprise-performance-operational-checklist.md) — enterprise-oriented operational checklist.
...
- [`wordpress-performance-incident-runbook.md`](wordpress-performance-incident-runbook.md) — incident-response procedures for active WordPress performance degradation.
...
Local planning state may exist during drafting, but publication focuses on the canonical Markdown sources, supporting review history, and generated artifacts. The generated PDF, DOCX, and EPUB files listed below are intentionally tracked publication artifacts, not disposable local exports.
...
PDF, Word, and EPUB artifacts are generated from the five source Markdown files with Pandoc and the Eisvogel LaTeX template.
...
- `WordPress-Performance-Incident-Runbook.{pdf,docx,epub}`
