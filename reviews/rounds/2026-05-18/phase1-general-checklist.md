...
- **Severity:** Medium
- **Recommendation:** Update both links to the current in-repo paths for `enterprise-performance-operational-checklist.md` and `DEVELOPER_REFERENCE.md`, or move the files so the published paths are real.
